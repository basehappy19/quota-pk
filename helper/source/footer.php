<footer style="border-top: 2px solid var(--bs-pink);background: #fff5f5;" class="mt-3">
            ...
            <div class="row">
                <div class="d-flex justify-content-center align-items-center col-lg-4 my-3">
                    ...
                    <div class="footer-address">
                        ...
                        <p>เลขที่ 142 หมู่ที่ 4 ตำบลผักปัง อำเภอภูเขียว จังหวัดชัยภูมิ 36110</p>
                    </div>
                </div>
                <div class="col-lg-4">
                    <h5 class="fw-semibold">ทีมพัฒนา</h5>
                    <ul class="development-team">
                        <li>นายภาคภูมิ ทีดินดำ ม.4/1 <br> Frontend/Backend UI/UX</li>
                        <li>นางสาวแทมมารีน ตาปราบ ม.4/1 <br> Frontend/Backend QA</li>
        ...
        <div class="footer-bottom" style="background-color: #5a5a5a;padding: 10px;color: var(--bs-white);">
            <p class="text-center" style="margin: 0;padding: 0;">© 2024 PHUKHIEO SCHOOL</p>
        </div>
    </footer>